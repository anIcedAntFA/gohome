...
- **JSON**: Auto-generated by `--save`, best for programmatic editing
- **YAML**: Human-friendly, great for manual editing with comments
- **TOML**: Clean syntax, good balance between JSON and YAML

You can convert between formats manually. Example config files are available in the repository:
